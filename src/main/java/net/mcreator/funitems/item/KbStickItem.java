...
package net.mcreator.funitems.item;
...
public class KbStickItem extends FunitemsModElements.ModElement {
	@ObjectHolder("funitems:kb_stick")
	public static final Item block = null;
	public KbStickItem(FunitemsModElements instance) {
		super(instance, 2);
	}
